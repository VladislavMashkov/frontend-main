...
import "../styles/LatestAdComponent.css";
import { jsx, css, Global, ClassNames } from '@emotion/react'
import styled from '@emotion/styled';
import DOMPurify from 'dompurify';

class LatestAd extends Component {
    constructor(props) {
        super(props);
        this.state = {
            showMore: false,
    ...
    return (
        ...
        <div className="latest-ad-container">
            <div className="latest-ad-content">
            <div className="latest-ad-type">
                Продажа
            </div>
            
            <div className="latest-ad-content-img" style={{ backgroundImage: `url('https://resizer.mail.ru/p/bfb6892b-d201-5a99-8ad8-7b071a9d461f/AAAc9zhILoLMo6htzGJBi6fdqzFisJclxbXTZKHvxwmg8fEX8UoWxVJptivn2L4VO5hrO2znCKqExJQ6BnUYadCZnz0.jpg')` }}></div>
            <div className="latest-ad-content-info-culture-name">
                Пшеница
            </div>
            <div className="latest-ad-content-info-culture-price">
                50 руб/тн
            </div>
            <div className="latest-ad-content-info-culture-place">
                Астраханская область
            </div>
            <div className="latest-ad-content-info-culture-weight">
                100 тонн
            </div>
